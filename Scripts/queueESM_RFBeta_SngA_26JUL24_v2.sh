...
fasta_dir='/projects/cpr_sbmm/people/phr361/AntiAntiPhage/ProteinDesignCompAug/att2/RF_beta/all_fastas'
fasta_files=(`ls ${fasta_dir}/`)  ## they will be indexed as 0,1,2,...
fasta_count=${#fasta_files[@]}
echo "Number of fastas = ${fasta_count} "

ESM_dir='/projects/cpr_sbmm/people/phr361/AntiAntiPhage/ProteinDesignCompAug/att2/RF_beta/ESM_outputs'  
mkdir -p ${ESM_dir}
