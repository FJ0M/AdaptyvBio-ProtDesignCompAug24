...
#SBATCH --array=0-999%4 ###CHANGE HERE###
#SBATCH --nice
...
fasta_dir='/projects/cpr_sbmm/people/phr361/AntiAntiPhage/ProteinDesignCompAug/att1/RF_normal/all_fastas'
fasta_files=(`ls ${fasta_dir}/`)  ## they will be indexed as 0,1,2,...
fasta_count=${#fasta_files[@]}
echo "Number of fastas = ${fasta_count} "

ESM_dir='/projects/cpr_sbmm/people/phr361/AntiAntiPhage/ProteinDesignCompAug/att1/RF_normal/ESM_outputs'  
mkdir -p ${ESM_dir}
